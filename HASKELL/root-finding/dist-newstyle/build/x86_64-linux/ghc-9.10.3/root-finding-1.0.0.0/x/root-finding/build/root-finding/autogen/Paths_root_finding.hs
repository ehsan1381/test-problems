...
-- at runtime using the environment variable root_finding_bindir.
...
-- environment variable root_finding_libdir.
...
-- using the environment variable root_finding_dynlibdir.
...
-- runtime using the environment variable root_finding_datadir.
...
-- variable root_finding_libexedir.
...
-- using the environment variable root_finding_sysconfdir.
...
bindir     = "/home/ehsan/.cabal/bin"
libdir     = "/home/ehsan/.cabal/lib/x86_64-linux-ghc-9.10.3-415c/root-finding-1.0.0.0-inplace-root-finding"
dynlibdir  = "/home/ehsan/.cabal/lib/x86_64-linux-ghc-9.10.3-415c"
datadir    = "/home/ehsan/.cabal/share/x86_64-linux-ghc-9.10.3-415c/root-finding-1.0.0.0"
libexecdir = "/home/ehsan/.cabal/libexec/x86_64-linux-ghc-9.10.3-415c/root-finding-1.0.0.0"
sysconfdir = "/home/ehsan/.cabal/etc"

getBinDir     = catchIO (getEnv "root_finding_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "root_finding_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "root_finding_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "root_finding_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "root_finding_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "root_finding_sysconfdir") (\_ -> return sysconfdir)
