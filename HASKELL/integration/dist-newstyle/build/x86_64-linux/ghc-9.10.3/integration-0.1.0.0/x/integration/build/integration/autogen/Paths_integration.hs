...
-- at runtime using the environment variable integration_bindir.
...
-- environment variable integration_libdir.
...
-- using the environment variable integration_dynlibdir.
...
-- runtime using the environment variable integration_datadir.
...
-- variable integration_libexedir.
...
-- using the environment variable integration_sysconfdir.
...
libdir     = "/home/ehsan/.cabal/lib/x86_64-linux-ghc-9.10.3-415c/integration-0.1.0.0-inplace-integration"
dynlibdir  = "/home/ehsan/.cabal/lib/x86_64-linux-ghc-9.10.3-415c"
datadir    = "/home/ehsan/.cabal/share/x86_64-linux-ghc-9.10.3-415c/integration-0.1.0.0"
libexecdir = "/home/ehsan/.cabal/libexec/x86_64-linux-ghc-9.10.3-415c/integration-0.1.0.0"
